    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Redaguoti imone</h5>
            ...
            <form >
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-update data-url="{{ route('companies-update', $company) }}" data-destroy class="btn btn-primary">Issaugoti</button>
                </div>
            </form>
