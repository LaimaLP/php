...
//jei nera tipo nustatyto, tuomet rodo inner Join
...
//SELECT * - viska is visu, vyksta overwritinimas, kurie sutampa

//cliento id, telefono id kaip pid, kitu nekeiciam, nes unikalus ir nepersiraso ant virsaaus
$sql = "
    SELECT c.id, p.id AS pid, name, number, client_id
    FROM clients AS c
    INNER JOIN phones3 AS p
    ON c.id = p.client_id  
";

}
//left joinas pasiima visus visus kurie yra lenteleje ir tuos kurie sujungti su lentele is antros lenteles
if ('left' == $type) {
